...
from core.models import Meeting, Channel
    ...
    if request.method=="POST":
        ...
        if Meeting.objects.filter(channel=channel):
            ...
            if Channel.objects.filter(app_id=app_id,channel=channel):
                ...
                save_channel.save()
            return redirect(url)
    return render(request, template_name='home/joinMeeting.html')
...
def meeting(request):
    ...
    return render(request, template_name='home/createmeeting.html', context=context)